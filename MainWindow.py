...
"font-weight:10000px;")
        ...
        self.component_image1 = ComponentWindow(self.original1, self.combo1, self.mode1, self.radioButton_In, self.frame)
...
"font-weight:10000px;")
        ...
        self.component_image2 = ComponentWindow(self.original2, self.combo2, self.mode1, self.radioButton_In, self.frame_2)
...
"font-weight:10000px;")
        ...
        self.component_image3 =ComponentWindow(self.original3, self.combo3, self.mode1, self.radioButton_In, self.frame_3)
...
"font-weight:10000px;")
        ...
        self.component_image4 = ComponentWindow(self.original4, self.combo4, self.mode1, self.radioButton_In, self.frame_4)
...
#"font-weight:10000px;")
        ...
        self.output1_port = OutputWindow([self.component_image1, self.component_image2, self.component_image3, self.component_image4], [self.Slider_weight1, self.Slider_weight2, self.Slider_weight3, self.Slider_weight4], [self.combo1, self.combo2, self.combo3, self.combo4], self.mode1, self.radioButton_In, self.frame_right)
...
#"font-weight:10000px;")
        ...
        self.output2_port = OutputWindow([self.component_image1, self.component_image2, self.component_image3, self.component_image4], [self.Slider_weight1, self.Slider_weight2, self.Slider_weight3, self.Slider_weight4], [self.combo1, self.combo2, self.combo3, self.combo4], self.mode1, self.radioButton_In, self.frame_right)
